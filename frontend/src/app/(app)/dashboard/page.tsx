    ...
    <div className="space-y-6 pb-12">
      ...
      {selectedSalesOrder && (
        <AppModal
          ...
          subtitle="Customer dispatch record & line breakdown"
          maxWidth="lg"
          leading={
      ...
      {selectedPurchaseOrder && (
        <AppModal
          ...
          subtitle="Vendor procurement order & raw materials"
          maxWidth="lg"
          leading={
...
function CreateSalesOrderModal({
  ...
  return (
    <AppModal
      ...
      subtitle="Select backend customer & furniture item"
      maxWidth="md"
      ...
      footer={
        <FormModalFooter
          ...
          onCancel={onClose}
          pending={submitting}
          submitDisabled={customers.length === 0 || products.length === 0}
          submitLabel={
            submitting ? (
              <>
    ...
    >
      ...
      <form id="create-sales-order-form" onSubmit={handleSubmit} className="space-y-4 text-xs">
          <div>
...
function CreatePurchaseOrderModal({
  ...
  return (
    <AppModal
      ...
      subtitle="Procure raw materials from backend vendor"
      maxWidth="md"
      disableClose={submitting}
      leading={
      ...
      footer={
        <FormModalFooter
          ...
          onCancel={onClose}
          pending={submitting}
          submitDisabled={vendors.length === 0 || products.length === 0}
          submitLabel={
            submitting ? (
              <>
                <RefreshCw className="h-3.5 w-3.5 animate-spin" />
    ...
    >
      ...
      <form id="create-purchase-order-form" onSubmit={handleSubmit} className="space-y-4 text-xs">
          <div>
