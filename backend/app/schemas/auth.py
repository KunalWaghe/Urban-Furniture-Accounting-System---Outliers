...
class RegisterRequest(BaseModel):
    ...
    role: Optional[str] = Field(default="contact", description="Public signup role (defaults to contact; admin and accountant not allowed)")
    ...
    def validate_role(cls, v: Optional[str]) -> str:
        if v is not None:
            ...
            if normalized in ("invoicing_user", "accountant"):
                raise ValueError("Registration with accountant role is forbidden")
        return v or "contact"
