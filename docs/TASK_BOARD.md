...
**Last updated:** 5 September 2026, 1:35 PM — P0-FE-01 fully done; P0-FE-02 (remainder) now in NOW  
...
- [ ] **P0-FE-02 (remainder)** — Auth Context + API client wiring · Sourabh · Started 1:35 PM · Depends: P0-FE-01 ✓ — Done when: login/signup forms submit credentials to backend, token saved, 401/422 handled
